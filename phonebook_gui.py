...
def load_gui (self):
    ...
    self.lbl_phone = tk.Label(slef.master,text='Phone Number:')
    self.lbl_phone.grid(row=4,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_email = tk.Label(slef.master,text='Phone Number:')
    self.lbl_email.grid(row=6,column=0,padx=(27,0),pady=(10,0),sticky=N+W)
    self.lbl_user = tk.Label(slef.master,text='Phone Number:')
